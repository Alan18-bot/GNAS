...
parser.add_argument('--train_output_dir',type=str, default='./RS_Train_outputs/')
parser.add_argument('--model_dir',type=str, default='./RS_Out_models/')
parser.add_argument('--test_dir',type=str, default='./RS_Test_models/')
